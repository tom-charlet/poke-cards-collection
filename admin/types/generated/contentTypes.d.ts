...
export interface ApiCardCard extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    slug: Attribute.UID<'api::card.card', 'name'> & Attribute.Required;
    localId: Attribute.Integer;
    ...
    stage: Attribute.Relation<
      ...
      'api::stage.stage'
    >;
    type: Attribute.Relation<'api::card.card', 'manyToOne', 'api::type.type'>;
    categorie: Attribute.Relation<
      'api::card.card',
      'manyToOne',
      'api::categorie.categorie'
    >;
    suffix: Attribute.Relation<
      'api::card.card',
      'manyToOne',
      'api::suffix.suffix'
    >;
    items: Attribute.Component<'content.card-item', true>;
    rarity: Attribute.Relation<
      'api::card.card',
      'manyToOne',
      'api::rarity.rarity'
    >;
...
export interface ApiOrderOrder extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    slug: Attribute.UID<'api::order.order', 'name'> & Attribute.Required;
...
export interface ApiQualityQuality extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    slug: Attribute.UID<'api::quality.quality', 'name'> & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiRarityRarity extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    slug: Attribute.UID<'api::rarity.rarity', 'name'> & Attribute.Required;
...
export interface ApiSetSet extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    slug: Attribute.UID<'api::set.set', 'name'> & Attribute.Required;
    logo: Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    symbol: Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    cardCount: Attribute.Component<'content.card-count'>;
...
export interface ApiSourceSource extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    slug: Attribute.UID<'api::source.source', 'name'> & Attribute.Required;
...
export interface ApiStageStage extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    slug: Attribute.UID<'api::stage.stage', 'name'> & Attribute.Required;
    cards: Attribute.Relation<
      'api::stage.stage',
      'oneToMany',
      'api::card.card'
...
export interface ApiSuffixSuffix extends Schema.CollectionType {
  collectionName: 'suffixes';
  info: {
    singularName: 'suffix';
    pluralName: 'suffixes';
  ...
  attributes: {
    name: Attribute.String;
    slug: Attribute.UID<'api::suffix.suffix', 'name'>;
    cards: Attribute.Relation<
      'api::suffix.suffix',
      'oneToMany',
      'api::card.card'
...
export interface ApiTypeType extends Schema.CollectionType {
  ...
  attributes: {
    ...
    cards: Attribute.Relation<'api::type.type', 'oneToMany', 'api::card.card'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiVariantVariant extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    slug: Attribute.UID<'api::variant.variant', 'name'> & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::suffix.suffix': ApiSuffixSuffix;
